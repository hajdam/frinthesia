 ...
 */
import frinthesia.gui.utils.BareBonesBrowserLaunch;
import frinthesia.gui.utils.WindowUtils;
...
public class AboutDialog extends javax.swing.JDialog implements HyperlinkListener {
    ...
    private final ResourceBundle bundle = ResourceBundle.getBundle("frinthesia/resources/AboutDialog");

    public AboutDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);

        appBundle = java.util.ResourceBundle.getBundle("frinthesia/resources/AboutDialog");
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("frinthesia/resources/AboutDialog"); // NOI18N
    ...
    public static void main(String args[]) {
        WindowUtils.invokeWindow(new AboutDialog(new javax.swing.JFrame(), true));
    }
